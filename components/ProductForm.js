    ...
    return (
        ...
        <form onSubmit={saveProduct}>
            ...
            <div className="mb-2 flex flex-wrap gap-1">
                ...
                <label className="w-24 h-24 cursor-pointer text-center flex flex-col items-center justify-center text-sm gqp-1 text-primary rounded-lg bg-white shadow-sm border border-gray-200">
